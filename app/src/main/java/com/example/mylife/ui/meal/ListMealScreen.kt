...
fun Item(name: String,
    ...
    Row(modifier = Modifier
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            Image(painter = painterResource(R.drawable.meal),
...
@Composable
fun MyLazyColumn(navigateToEachMeal: () -> Unit) {
    Text(text = "List Meal:",
    ...
    LazyColumn {
        item {
            ...
            Item(name = "Meal 1", navigateToEachMeal)
            Spacer(modifier = Modifier.height(10.dp))
            Item(name = "Meal 2",  navigateToEachMeal)
            Spacer(modifier = Modifier.height(10.dp))
            Item(name = "Meal 3",  navigateToEachMeal)
            Spacer(modifier = Modifier.height(10.dp))
            Item(name = "Meal 4",  navigateToEachMeal)
            Spacer(modifier = Modifier.height(10.dp))
            Item(name = "Meal 5", navigateToEachMeal)
            Spacer(modifier = Modifier.height(10.dp))
        }
    }
}
